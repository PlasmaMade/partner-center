...
window.PM_LOCALES.de = {
  "name": "Deutsch",
  "ui": {
    "nav.dashboard": "Partner-Dashboard",
    "nav.products": "Produktinformationen",
    "nav.finder": "Filter-Finder",
    "nav.knowledge": "Wissensdatenbank",
    "nav.videos": "Videoanleitungen",
    "nav.marketing": "Marketingmaterialien",
    "nav.campaigns": "Kampagnen",
    "nav.sales": "Vertriebstools",
    "nav.designs": "Meine Designs",
    "nav.studio": "Design Studio",
    "nav.brand": "Markenrichtlinien",
    "nav.downloads": "Downloads",
    "nav.testdocs": "Testdokumente",
    "nav.news": "Neuigkeiten & Updates",
    ...
    "designs.intro": "Status, Feedback und Freigabe für jedes gespeicherte Design.",
    "designs.overviewLabel": "Übersicht meiner Designs",
    "designs.searchPh": "Designs durchsuchen",
    "designs.allStatuses": "Alle Status",
    "designs.status.draft": "Entwurf",
    "designs.status.submitted": "Eingereicht",
    "designs.status.in_review": "In Prüfung",
    "designs.status.approved": "Freigegeben",
    "designs.status.rejected": "Abgelehnt",
    "designs.status.changes_requested": "Änderungen erforderlich",
    "designs.status.downloaded": "Heruntergeladen",
    "designs.format.ig-square": "Quadratischer Social-Post",
    ...
    "designs.format.product-card": "Produktkarte",
    "designs.format.dealer": "Händleranzeige",
    "designs.format.banner": "Banner",
    "designs.format.newsletter": "Newsletter-Kopfzeile",
    "designs.format.presentation": "Präsentation 16:9",
    "designs.format.custom": "Benutzerdefiniert",
    "designs.format.design": "Design",
    "designs.feedback": "Feedback: {text}",
    "designs.reason": "Grund: {text}",
    "designs.message.changes_requested": "Änderungen sind erforderlich. Eine Erläuterung wurde noch nicht hinzugefügt.",
    "designs.message.rejected": "Nicht freigegeben. Es wurde kein Grund angegeben.",
    "designs.message.approved": "Zur Verwendung freigegeben. Der Export ist im Studio verfügbar.",
    "designs.message.downloaded": "Freigegeben und heruntergeladen. Sie können das Design im Studio erneut exportieren.",
    "designs.message.submitted": "Eingereicht. Wartet auf die Prüfung durch PlasmaMade.",
    "designs.message.in_review": "In Prüfung. Feedback oder Freigabe erscheint hier.",
    "designs.message.draft": "Entwurf. Noch nicht zur Freigabe eingereicht.",
    "designs.select": "Wählen Sie ein Design aus, um Status, Feedback und Freigabe anzuzeigen.",
    "designs.meta.status": "Status",
    "designs.meta.updated": "Zuletzt aktualisiert",
    "designs.meta.format": "Format",
    "designs.meta.pages": "Seiten",
    "designs.meta.account": "Konto",
    "designs.editStudio": "Im Studio bearbeiten",
    "designs.new": "Neues Design",
    "designs.empty": "Keine gespeicherten Designs gefunden.",
    "designs.countOne": "1 Design",
    "designs.count": "{n} Designs",
    "designs.exportAvailable": "Export verfügbar",
    "designs.feedbackReceived": "Feedback erhalten",
    "designs.notApproved": "nicht freigegeben",
    "designs.waitingReview": "wartet auf Prüfung",
    "dash.myDesigns": "Meine Designs",
    "dash.allDesigns": "Alle Designs",
    "dash.noDesigns": "Noch keine Designs. Öffnen Sie das Design Studio, um Material zu erstellen und zur Freigabe einzureichen.",
    ...
    "login.reqFirst": "Vorname",
    "login.reqLast": "Nachname",
    "login.reqPassword": "Passwort erstellen",
    "login.reqPassword2": "Passwort wiederholen",
    "login.reqCompany": "Firmenname",
    "login.reqFunction": "Position",
    ...
    "dash.statArticles": "Wissensartikel",
    "dash.statArticlesSub": "+ Videoanleitungen",
    ...
    "products.view": "Anzeigen Produkt",
    "products.emptyTitle": "Keine Produkte found",
    "products.emptyText": "Adjust Ihre suchen.",
    "products.guideTitle": "Which Produkt should Sie choose?",
    "products.guideSituation": "Ihre situation",
    ...
    "account.fldCompany": "Unternehmen",
    "account.fldEmail": "E-Mail-Adresse",
    ...
    "account.actDesignsSub": "Im Design Studio",
    "account.actFavorites": "Favoriten",
    ...
    "camp.makeMaterial": "Erstellen Kampagne Materialien",
    "camp.status": "Status",
    ...
    "sales.pitch30": "30-Sekunden-Pitch",
    "sales.perAudience": "Pitch pro Zielgruppe",
    ...
    "support.companyPh": "Ihre Unternehmen",
    "support.email": "E-Mail",
    "support.emailPh": "sie@firma.de",
    "support.phone": "Telefon (optional)",
    "support.phonePh": "+44 …",
    "support.category": "Kategorie",
    "support.cat1": "Produkt question",
    ...
    "studio.submit": "Einreichen",
    "studio.submittedForApproval": "Design zur Freigabe eingereicht",
    "studio.downloadApprovedTitle": "Freigegebene Version herunterladen",
    "studio.downloadLockedTitle": "Download ist nach der Freigabe verfügbar",
    "studio.downloadLocked": "Der Download ist verfügbar, nachdem PlasmaMade dieses Design freigegeben hat.",
    "studio.export": "Exportieren",
    "studio.namePh": "Designname",
    ...
    "studio.exportJpg": "Herunterladen as JPG",
    "studio.exportPdf": "Herunterladen as PDF (alle pages)",
    "studio.exportClip": "Kopieren to clipboard",
    "studio.myDesigns": "Meine Designs",
    "studio.previewTitle": "Vorschau",
    "studio.shortcuts": "Keyboard shodertcuts",
    ...
    "studio.kbdGuides": "Tempoderarily disable guides",
    "studio.kbdGuidesKey": "Alt beim Ziehen",
    "studio.kbdDeselect": "Deselect / stop bearbeitening",
    "studio.tabTemplates": "Vorlagen",
    "studio.tabText": "Text",
    "studio.tabImages": "Bilder",
    ...
    "studio.layerLock": "Sperren",
    "studio.layerUnlock": "Entsperren",
    ...
    "studio.alignCenter": "Zentriert",
    "studio.alignRight": "Rechts",
    "studio.alignCenterH": "Centre hoderizontalley",
    "studio.alignCenterV": "Centre verticalley",
    "studio.alignTop": "Top",
    "studio.alignBottom": "Unten",
    "studio.propStyle": "Stil",
    "studio.propItalic": "Kursiv",
    "studio.propUnderline": "Unterstrichen",
    "studio.propShadow": "Schatten",
    "studio.propLineHeight": "Zeilenhohe",
    "studio.propLetterSpacing": "Zeichenabstand",
    "studio.propColor": "Farbe",
    "studio.propFit": "Anzeige",
    "studio.propRadius": "Rundung",
    "studio.propMirror": "Mirroder",
    "studio.propMirrorH": "Hoderizontal",
    "studio.propMirrorV": "Vertikal",
    "studio.propFilters": "Filter",
    "studio.propBrightness": "Helligkeit",
    ...
    "studio.ungrouped": "Gruppierung gelost",
    "studio.distribute": "Gleichmassig verteilen",
    "studio.distributeH": "Hoderizontalley",
    "studio.distributeV": "Verticalley",
    "studio.more": "Mehr actions",
  ...
  "content": {
    "categories": {
      ...
      "Mijlpaal": "Meilenstein",
      "Partner": "Partner",
      "Prestatie & luchtkwaliteit": "Leistung & Luftqualitat",
      "Veiligheid": "Sicherheit",
      "Certificering & patent": "Zertifizierung & Patent"
    },
    "audiences": {
    ...
    "statuses": {
      "Doorlopend": "Laufend",
      "Actueel — Award": "Aktuell — Award",
      "Seizoen — Lente": "Seasonal — Spring",
      "Actief — B2B": "Aktiv — B2B",
      "Actie": "Promotion",
      "Beurs": "Trade fair",
    ...
    "studioAssets": {
      ...
      "ESP-module reinigen": "ESP-Modul reinigen",
      "Vlinders (transp.)": "Schmetterlinge (transp.)"
    },
    "studioShapes": {
    ...
    "specLabels": {
      ...
      "Max. luchtdoorvoer": "Max. Luftdurchsatz",
      "Spanning": "Spannung",
      "Max. vermogen": "Max. Leistung",
      "Stand-by": "Stund-by",
      "Aansluiting": "Anschluss",
      "Afmetingen filter": "Filterabmessungen",
      "Aansluitlengte": "Anschlusslange",
      "Gewicht filter": "Filtergewicht",
      "Gewicht in doos": "Gewicht im Karton",
      "Verpakking": "Verpackung",
      "Pallet (30 st.)": "Palette (30 St.)",
      ...
      "Stand 1": "Stufe 1",
      "Stand 2": "Stufe 2",
      "Automatische stand": "Automatikmodus",
      "Fijnstof reductie": "Feinstaubreduktion",
      "Ziekteverwekkers": "Krankheitserreger",
      "Onderhoud": "Wartung",
      "Type": "Typ",
      "Werking": "Betrieb",
      "Filtermateriaal": "Filtermaterial",
    ...
    "specValues": {
      "1.000 m³/h": "1,000 m³/h",
      "Ø147/Ø151 mm of Ø122/Ø126 mm": "Ø147/Ø151 mm oder Ø122/Ø126 mm",
      "1.000 gr": "1,000 g",
      "2.000 gr": "2,000 g",
      "800 gr": "800 g",
      "1.600 gr": "1,600 g",
    ...
    "products": {
      ...
      "guc4184-esp": {
        ...
        "tagline": "Der ESP-Baustein des AirClean UltraFine: elektrostatische Prazision ohne Filtermaterial.",
        "description": "Der GUC4184 ist ein Electrostatic Precipitator (ESP): ein fortschrittliches Luftreinigungssystem, das mit elektrostatischer Anziehung arbeitet. Statt Luft durch einen dichten Filter zu pressen, nutzt der ESP elektrische Ladungen, um Verunreinigungen aktiv anzuziehen und festzuhalten — leise, effizient und langlebig.",
        "benefits": [
        ...
        "salesArguments": [
          ...
          "Kombiniert mit dem GUC1223 E-Filter zum AirClean UltraFine."
        ]
      },
      "table-air-cleaner": {
    ...
    "sales": {
      ...
      "comparison": [
        ...
        {
          "feature": "Abluft",
          "trad": "Abluftkanal erforderlich",
          "pm": "Umluft, kein Kanal erforderlich"
        },
        {
          "feature": "Steuerung",
          "trad": "Keine digitale Steuerung",
          "pm": "WiFi + Bluetooth app"
        },
        {
          "feature": "Material",
          "trad": "Wegwerfkunststoff",
          "pm": "97% recycelbar"
        },
        {
          "feature": "Geräusch",
      ...
      "objections": [
        ...
        {
          "q": "\"Ist es nachhaltig?\"",
          "a": "Sehr. 97% recycelbar, keine Wegwerffilter und dank geringem Luftwiderstand niedrigerer Energieverbrauch. Kein Wegwerffilter — nie wieder."
        }
      ],
      "productArgs": [
        {
