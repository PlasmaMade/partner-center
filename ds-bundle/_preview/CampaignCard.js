var __dsPreview = (() => {
  ...
  // .design-sync/previews/CampaignCard.tsx
  var CampaignCard_exports = {};
  __export(CampaignCard_exports, {
    Default: () => Default,
    Pair: () => Pair
  });
  init_define_import_meta_env();
  ...
  var Default = () => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { maxWidth: 360 }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    ds_exports.CampaignCard,
    {
      image: campaignImg,
      badge: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_exports.Badge, { tone: "green", children: "Zomeractie" }),
      title: "Frisse lucht, hele zomer",
      description: "Kant-en-klare social posts en banners voor de zomercampagne."
    }
  ) });
  var Pair = () => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "grid", gridTemplateColumns: "repeat(2, minmax(0,1fr))", gap: 16, maxWidth: 560 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_exports.CampaignCard, { image: campaignImg, badge: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_exports.Badge, { tone: "green", children: "Zomeractie" }), title: "Frisse lucht, hele zomer", description: "Social posts en banners." }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_exports.CampaignCard, { image: campaignImg, badge: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ds_exports.Badge, { tone: "dark", children: "Nieuw" }), title: "Ultrafine lancering", description: "Introduceer de nieuwe lijn." })
  ] });
  return __toCommonJS(CampaignCard_exports);
})();
